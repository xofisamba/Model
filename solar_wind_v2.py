...
def calculate_lcoe():
    ...
    for year in range(1, st.session_state.investment_horizon + 1):
        ...
        opex = calculate_opex_year(year)
        total_opex += opex * ((1 + st.session_state.tariff_escalation) ** (year - 1))
        total_generation += gen * ((1 + st.session_state.tariff_escalation) ** (year - 1))
...
# Show hero and KPI only on non-dashboard sheets
...
# ============================================================================
    ...
    years = list(range(1, min(21, st.session_state.investment_horizon + 1)))
...
# ============================================================================
    ...
    years = list(range(0, min(21, st.session_state.investment_horizon + 1)))
    ...
    for year in years:
        if year == 0:
            ...
            annual_depr = gfa * depreciation_rate
